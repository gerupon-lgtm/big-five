...
function presentationRows() {
  ...
  return {
    scenes: definition.scenes.map(({ sceneId, label, iconId }, index) => ({ scene_id: sceneId, presentation_definition_version: presentationVersion, display_order: index + 1, label, icon_id: iconId, status: "approved" })),
    ...
    fragrances: definition.fragrances.map(({ fragranceId, sceneId, familyId, accordLabel, description, disclaimerId }, index) => ({ fragrance_id: fragranceId, presentation_definition_version: presentationVersion, display_order: index + 1, scene_id: sceneId, family_id: familyId, accord_label: accordLabel, description, disclaimer_id: disclaimerId, status: "approved" })),
