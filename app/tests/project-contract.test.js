...
test("Q-006 records E-1 through E-3 and F-1 through F-3 as approved while the overall gate stays open", async () => {
  ...
  assert.match(gateSection, /E-4〜E-5[^。\n]*draft[^。\n]*承認日なし/);
  ...
  assertIncludesAll(specReviewedGateLine, ["F-4〜F-5", "reviewed", "人手approval record", "ない"], documentPaths.t005Spec);
