...
test("Q-006 records only E-1/E-2 and F-1/F-2 as approved while the overall gate stays open", async () => {
  ...
  assert.match(gateSection, /E-3〜E-5[^。\n]*draft[^。\n]*承認日なし/);
  ...
  assertIncludesAll(specReviewedGateLine, ["F-3〜F-5", "reviewed", "人手approval record", "ない"], documentPaths.t005Spec);
  ...
  assertIncludesAll(taskGate, ["initial reviewed copy", "Content Approval pending", "E-0", "E-1", "E-2", "E-3〜E-5", "T-0〜T-4", "F-1", "F-2", "F-3〜F-5", "X-1〜X-2"], documentPaths.tasks);
