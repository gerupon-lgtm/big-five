...
test("Q-006 records E-1 through E-4 and F-1 through F-4 as approved while the overall gate stays open", async () => {
  ...
  assertIncludesAll(specReviewedGateLine, ["F-5", "reviewed", "人手approval record", "ない"], documentPaths.t005Spec);
