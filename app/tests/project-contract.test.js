...
test("Q-006 records E-1 through E-5 and F-1 through F-5 as approved while the overall gate stays open", async () => {
  ...
  assertIncludesAll(specReviewedGateLine, ["reviewed", "人手approval record", "ない"], documentPaths.t005Spec);
  assert.doesNotMatch(specReviewedGateLine, /F-5/);
  ...
  assertIncludesAll(taskGate, ["initial reviewed copy", "Content Approval pending", "E-0", "E-1", "E-2", "E-3", "E-4", "E-5", "T-0〜T-4", "F-1", "F-2", "F-3", "F-4", "F-5", "X-1〜X-2"], documentPaths.tasks);
