...
test("AppMeta is the canonical mvp-1.3.3 normal-build metadata", () => {
  assert.equal(appMeta.appVersion, "mvp-1.3.3");
...
test("diagnostic, start, and share models read the same canonical version registry", () => {
  ...
  assert.deepEqual(startModel, {
    appVersion: "mvp-1.3.3",
    versionLabel: "バージョン mvp-1.3.3",
