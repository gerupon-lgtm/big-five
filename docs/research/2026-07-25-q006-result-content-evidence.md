...
E-1は知性・想像力、E-2は勤勉性、E-3は外向性、E-4は協調性のhigh/middle/low語彙、根拠ID、20問・50問の対象各27文をContent Approval Gatesでレビューし、2026-07-28にユーザー承認された。E-5は、ここに記した項目対応だけでは`approved`にならず、情緒安定性の20問・50問文面バッチをレビューした後に限り更新する。承認日のない`draft`へ日付を補わない。

F-1は知性・想像力、F-2は勤勉性、F-3は外向性、F-4は協調性の20問観察文と50問8節について、対応するE gateと同じ対象各27文を2026-07-28にユーザー承認した。F-5、T-0〜T-4、X-1〜X-2は`reviewed`だが人手approval recordがなく、Q-006全体は`Content Approval pending`のままである。
