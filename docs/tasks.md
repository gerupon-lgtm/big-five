...
- 未実装: 回答完答からの本番caller、S-003/S-004結果画面、履歴カードから独立したS-003/S-004へ開く遷移。現在の履歴カードでは診断時文面を`details`で展開できる。猫画像・レーダー・色香りを含む結果詳細はT-005で接続する。
...
- 検証: 履歴・比較・画面・契約集中53件、全336件、`npm.cmd run check`、`git diff --check`成功。
...
| 結果・履歴画面統合 | Q-006ドメイン、ResultSnapshot保存、S-006履歴、S-007比較は実装済み。S-003/S-004、履歴から独立結果画面を開く遷移、完答callerが未実装 | T-005/T-006 |
